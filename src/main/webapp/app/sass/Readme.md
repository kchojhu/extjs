...
folder are mapped to the application's root namespace, 'SlickDeals'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SlickDeals' in the same way
as `"SlickDeals/sass/src"`.
