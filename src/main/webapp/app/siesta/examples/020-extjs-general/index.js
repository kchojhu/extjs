...
Harness.configure({
    ...
    preload : [
        "https://extjs.cachefly.net/ext/gpl/5.0.1/packages/ext-theme-crisp/build/resources/ext-theme-crisp-all-debug.css",
        "https://extjs.cachefly.net/ext/gpl/5.0.1/build/ext-all-debug.js"
    ]
});
